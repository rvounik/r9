...
async function getAll(req, res) {
    ...
    res.status(200).json(pages); // remember, .json() is similar to the send method, internally
}

async function getById(req, res) {
    const page = await models.pages.findOne({ where: { id: req.params.id } });
